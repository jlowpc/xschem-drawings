...
C {devices/ipin.sym} 1890 1750 0 0 {name=p2204 lab=addr0[0:3] }
...
C {devices/lab_wire.sym} 2200 1770 0 1 {lab=a0[0:3] }
...
C {devices/opin.sym} 5390 4440 0 0 {name=p6 lab=dout0[0:1] }
