...
N 1890 1750 2010 1750 { lab=addr0[0:3]}
N 2170 1770 2780 1770 { lab=a0[0:3]}
...
N 5280 4440 5390 4440 { lab=dout0[0:1]}
...
N 2560 4290 2780 4290 { lab=s_en0}
...
C {ipin.sym} 1890 2920 0 0 {name=p2203 lab=din0[0:1] }
C {ipin.sym} 1890 1750 0 0 {name=p2204 lab=addr0[0:3] }
...
C {lab_wire.sym} 2200 1770 0 1 {lab=a0[0:3] }
C {row_addr_dff.sch} 890 1710 0 0 {name=xrow_address0 }
C {lab_wire.sym} 2400 2940 0 1 {lab=bank_din0[0:1] }
C {lab_wire.sym} 1990 2990 0 0 {lab=clk_buf0 }
...
C {opin.sym} 5390 4440 0 0 {name=p6 lab=dout0[0:1] }
