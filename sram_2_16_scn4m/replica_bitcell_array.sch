...
C {iopin.sym} 600 -90 0 1 {name=p1 lab=rbl_bl[0]}
C {iopin.sym} 2180 -90 0 0 {name=p2 lab=rbl_br[0]}
C {iopin.sym} 600 250 0 1 {name=p3 lab=bl[0:1]}
C {iopin.sym} 2180 250 0 0 {name=p4 lab=br[0:1]}
C {ipin.sym} 600 110 0 0 {lab=rbl_wl[0]}
...
C {lab_wire.sym} 860 -1180 0 0 {name=l1 sig_type=std_logic lab=dummy_right_bl_0_0}
C {lab_wire.sym} 1450 -1170 1 1 {name=l2 sig_type=std_logic lab=dummy_right_br_0_0}
C {lab_wire.sym} 850 -620 0 0 {name=l7 sig_type=std_logic lab=dummy_left_bl_0_0}
C {lab_wire.sym} 1450 -610 1 1 {name=l8 sig_type=std_logic lab=dummy_left_br_0_0}
C {lab_pin.sym} 1110 410 0 0 {name=l20 sig_type=std_logic lab=gnd}
C {lab_pin.sym} 1110 740 0 0 {name=l21 sig_type=std_logic lab=gnd}
C {noconn.sym} 720 -1180 0 0 {name=l22}
C {noconn.sym} 1450 -1100 1 1 {name=l23}
C {noconn.sym} 720 -620 0 0 {name=l24}
C {noconn.sym} 1450 -540 1 1 {name=l25}
C {dummy_array_1.sch} 1410 760 0 0 {name=xdummy_row_bot vdd=vdd gnd=gnd}
C {lab_pin.sym} 960 -210 0 0 {name=l3 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {replica_column.sch} 1110 -650 0 0 {name="" prefix=sky130_fd_sc_hd__ vdd=vdd gnd=gnd spice_ignore=true}
C {lab_wire.sym} 890 -1310 0 0 {name=l4 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {lab_wire.sym} 880 -750 0 0 {name=l5 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
