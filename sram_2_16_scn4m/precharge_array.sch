...
C {opin.sym} 450 -450 0 1 {name=p1484 lab=bl_0 }
C {opin.sym} 1000 -450 0 0 {name=p1485 lab=br_0 }
C {opin.sym} 450 -260 0 1 {name=p1486 lab=bl_1 }
C {opin.sym} 1000 -260 0 0 {name=p1487 lab=br_1 }
C {opin.sym} 450 -120 0 1 {name=p1488 lab=bl_2 }
C {opin.sym} 1000 -120 0 0 {name=p1489 lab=br_2 }
C {ipin.sym} 450 -520 0 0 {name=p1490 lab=en_bar }
C {lab_pin.sym} 880 -460 0 1 {name=p1473 lab=br_0 }
