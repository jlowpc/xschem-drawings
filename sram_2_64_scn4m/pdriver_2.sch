...
C {devices/ipin.sym} -300 -10 0 0 {name=p1817 lab=A }
C {devices/opin.sym} 380 -10 0 0 {name=p1818 lab=Z }
C {devices/lab_wire.sym} -150 -10 0 1 {name=l1802 lab=Zb1_int }
C {pinv_1.sym} -220 -10 0 0 {name=xbuf_inv1 }
C {devices/lab_wire.sym} 30 -10 0 1 {name=l1806 lab=Zb2_int }
C {pinv_10.sym} -50 -10 0 0 {name=xbuf_inv2 }
C {devices/lab_wire.sym} 190 -10 0 1 {name=l1810 lab=Zb3_int }
