...
C {iopin.sym} 600 -1950 0 1 {name=p1 lab=rbl_bl[0]}
C {iopin.sym} 5930 -1950 0 0 {name=p2 lab=rbl_br[0]}
C {iopin.sym} 600 -660 0 1 {name=p3 lab=bl[0:7]}
C {iopin.sym} 5930 -660 0 0 {name=p4 lab=br[0:7]}
C {ipin.sym} 600 -790 0 0 {lab=rbl_wl[0]}
...
C {lab_wire.sym} 1080 -3100 0 0 {name=l1 sig_type=std_logic lab=dummy_right_bl_0_0}
C {lab_wire.sym} 1670 -3090 1 1 {name=l2 sig_type=std_logic lab=dummy_right_br_0_0}
C {lab_wire.sym} 1070 -2540 0 0 {name=l7 sig_type=std_logic lab=dummy_left_bl_0_0}
C {lab_wire.sym} 1670 -2530 1 1 {name=l8 sig_type=std_logic lab=dummy_left_br_0_0}
C {lab_pin.sym} 1110 -200 0 0 {name=l20 sig_type=std_logic lab=gnd}
C {lab_pin.sym} 1110 410 0 0 {name=l21 sig_type=std_logic lab=gnd}
C {noconn.sym} 940 -3100 0 0 {name=l22}
C {noconn.sym} 1670 -3020 1 1 {name=l23}
C {noconn.sym} 940 -2540 0 0 {name=l24}
C {noconn.sym} 1670 -2460 1 1 {name=l25}
C {dummy_array_1.sch} 1110 620 0 0 {name=xdummy_row_bot vdd=vdd gnd=gnd}
C {lab_pin.sym} 980 -2070 0 0 {name=l3 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {replica_column.sch} 710 -1350 0 0 {name=xreplica_col_0  prefix=sky130_fd_sc_hd__ vdd=vdd gnd=gnd }
C {lab_wire.sym} 1110 -3230 0 0 {name=l4 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {lab_wire.sym} 1100 -2670 0 0 {name=l5 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
