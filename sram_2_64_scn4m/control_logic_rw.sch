...
C {devices/opin.sym} 1390 -40 0 0 {name=p2152 lab=s_en }
C {devices/opin.sym} 1390 -160 0 0 {name=p2153 lab=w_en }
C {devices/opin.sym} 1390 -340 0 0 {name=p2154 lab=p_en_bar }
C {devices/opin.sym} 1390 -250 0 0 {name=p2155 lab=wl_en }
C {pdriver_1.sym} 380 -580 0 0 {name=xclkbuf }
C {devices/lab_pin.sym} 460 -560 2 0 {name=p2101 lab=clk_buf }
C {devices/lab_wire.sym} 590 -260 0 1 {name=l2102 lab=clk_bar }
C {pinv_2.sym} 510 -260 0 0 {name=xinv_clk_bar }
C {devices/lab_pin.sym} 630 -240 0 0 {name=p2106 lab=cs }
C {devices/lab_wire.sym} 790 -250 0 1 {name=l2107 lab=gated_clk_bar }
C {pand2_0.sym} 730 -250 0 0 {name=xand2_gated_clk_bar }
C {devices/lab_wire.sym} 570 -350 0 1 {name=l2112 lab=gated_clk_buf }
C {pand2_0.sym} 520 -350 0 0 {name=xand2_gated_clk_buf }
C {devices/lab_wire.sym} 990 -250 0 1 {name=l2116 lab=wl_en }
C {pdriver_2.sym} 930 -250 0 0 {name=xbuf_wl_en }
C {devices/lab_wire.sym} 840 -160 0 1 {name=l2120 lab=rbl_bl_delay_bar }
C {pinv_2.sym} 780 -160 0 0 {name=xrbl_bl_delay_inv }
C {devices/lab_wire.sym} 1020 -180 0 0 {lab=we }
C {devices/lab_wire.sym} 980 -140 0 0 {lab=gated_clk_bar }
C {pand3.sym} 1180 -160 0 0 {name=Xw_en_and }
C {pand3_0.sym} 1180 -40 0 0 {name=Xbuf_s_en_and }
C {devices/lab_wire.sym} 670 -160 0 1 {lab=rbl_bl_delay }
C {delay_chain.sym} 470 -140 0 0 {name=Xdelay_chain vdd=vdd gnd=gnd}
C {devices/lab_wire.sym} 790 -340 0 1 {lab=p_en_bar_unbuf }
C {pnand2_1.sym} 720 -340 0 0 {name=Xnand_p_en_bar }
C {pdriver_5.sym} 930 -340 0 0 {name=xbuf_p_en_bar }
C {dff_buf_array.sch} 1320 -350 0 0 {name=Xctrl_dffs  prefix=sky130_fd_sc_hd__ vdd=vdd gnd=gnd}
C {devices/ipin.sym} 300 -660 0 0 {name=p1 lab=csb }
C {devices/ipin.sym} 300 -630 0 0 {name=p2 lab=web }
C {devices/opin.sym} 1390 -400 0 0 {name=p3 lab=clk_buf}
C {devices/lab_pin.sym} 450 -340 0 0 {name=p4 lab=cs }
C {devices/lab_wire.sym} 1220 -160 0 0 {lab=w_en}
