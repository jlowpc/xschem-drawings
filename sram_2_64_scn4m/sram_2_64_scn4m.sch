...
C {ipin.sym} 1890 4030 0 0 {name=p2203 lab=din0[0:1] }
C {ipin.sym} 960 1740 0 0 {name=p2204 lab=addr0[0:5] }
C {ipin.sym} 1270 2050 0 0 {name=p2205 lab=csb0 }
C {ipin.sym} 1270 2080 0 0 {name=p2206 lab=web0 }
C {ipin.sym} 1270 2130 0 0 {name=p2207 lab=clk0 }
C {lab_wire.sym} 1330 2550 0 0 {lab=rbl_bl0 }
C {lab_wire.sym} 2200 1770 0 1 {lab=a0[2:5] }
C {row_addr_dff.sch} 890 1710 0 0 {name=xrow_address0 }
C {lab_wire.sym} 2400 4050 0 1 {lab=bank_din0[0:1] }
C {lab_wire.sym} 1990 4100 0 0 {lab=clk_buf0 }
C {col_addr_dff.sch} 1820 4320 0 0 {name=xdata_dff0 }
C {lab_wire.sym} 1980 1820 0 0 {lab=clk_buf0 }
...
C {lab_wire.sym} 2480 2670 0 1 {lab=s_en0 }
C {lab_pin.sym} 2500 2310 0 1 {name=p5 lab=clk_buf0 }
...
C {lab_wire.sym} 2750 2460 0 0 {lab=wl_en0 }
C {lab_pin.sym} 2670 2390 0 0 {name=p7 lab=p_en_bar0 }
C {lab_pin.sym} 2740 2570 0 0 {name=p8 lab=w_en0 }
C {opin.sym} 9260 4720 0 0 {name=p6 lab=dout0[0:1] }
C {ipin.sym} 1890 1720 0 0 {name=p1 lab=gnd}
C {ipin.sym} 1890 1700 0 0 {name=p2 lab=vdd}
C {bus_connect.sym} 1020 1740 1 0 {name=l1 lab=addr0[2:5]}
C {bus_connect.sym} 1020 3270 1 0 {name=l2 lab=addr[0:1]}
C {col_addr_dff.sch} 1910 3570 0 0 {name=Xcol_address0 prefix=sky130_fd_sc_hd__ vdd=vdd gnd=gnd}
C {lab_wire.sym} 2380 3300 0 0 {name=l3 sig_type=std_logic lab=a0[0:1]}
C {lab_wire.sym} 2080 3350 0 0 {lab=clk_buf0 }
