...
C {devices/iopin.sym} 600 -640 0 1 {name=p1 lab=rbl_bl[0]}
C {devices/iopin.sym} 3290 -640 0 0 {name=p2 lab=rbl_br[0]}
C {devices/iopin.sym} 600 710 0 1 {name=p3 lab=bl[0:3]}
C {devices/iopin.sym} 3290 710 0 0 {name=p4 lab=br[0:3]}
C {devices/ipin.sym} 600 500 0 0 {lab=rbl_wl[0]}
...
C {devices/lab_wire.sym} 1120 -1790 0 0 {name=l1 sig_type=std_logic lab=dummy_right_bl_0_0}
C {devices/lab_wire.sym} 1720 -1790 0 1 {name=l2 sig_type=std_logic lab=dummy_right_br_0_0}
C {devices/lab_wire.sym} 1110 -1230 0 0 {name=l7 sig_type=std_logic lab=dummy_left_bl_0_0}
C {devices/lab_wire.sym} 1710 -1230 0 1 {name=l8 sig_type=std_logic lab=dummy_left_br_0_0}
C {devices/lab_pin.sym} 1110 680 0 0 {name=l20 sig_type=std_logic lab=gnd}
C {devices/lab_pin.sym} 1110 850 0 0 {name=l21 sig_type=std_logic lab=gnd}
C {devices/noconn.sym} 980 -1790 0 0 {name=l22}
C {devices/noconn.sym} 1860 -1790 0 1 {name=l23}
C {devices/noconn.sym} 980 -1230 0 0 {name=l24}
C {devices/noconn.sym} 1860 -1230 0 1 {name=l25}
C {dummy_array_1.sch} 1410 850 0 0 {name=xdummy_row_bot vdd=vdd gnd=gnd}
C {devices/lab_pin.sym} 970 -760 0 0 {name=l3 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {replica_column.sch} 700 -40 0 0 {name=xreplica_col_0  prefix=sky130_fd_sc_hd__ vdd=vdd gnd=gnd}
C {devices/lab_wire.sym} 1150 -1920 0 0 {name=l4 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
C {devices/lab_wire.sym} 1140 -1360 0 0 {name=l5 sig_type=std_logic lab=gnd,rbl_wl[0],wl[0:15],gnd}
