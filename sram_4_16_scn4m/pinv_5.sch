...
G {}
K {type=subcircuit
format="@name @@A @@Z @vdd @gnd pinv_5"
...
C {devices/nmos-sub.sym} -10 60 0 0 {name=Mpinv_nmos model=n substrate=gnd
L=0.4u
W=0.8u
m=1
}
C {devices/pmos-sub.sym} -10 -30 0 0 {name=Mp_inv_pmos model=p substrate=vdd
L=0.4u
W=1.6u
m=1
}
...
C {yxt_title.sym} -90 180 0 0 {name=l3 author="Joanne Low" note="Circuits created by Openram"}
