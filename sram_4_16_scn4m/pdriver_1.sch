...
C {pinv_9.sym} -120 0 0 0 {name=xbuf_inv2 }
C {lab_wire.sym} 120 0 0 1 {name=l1810 lab=Zb3_int }
C {pinv_6.sym} 50 -10 0 0 {name=xbuf_inv3 }
C {pinv_10.sym} 220 0 0 0 {name=xbuf_inv4 }
C {yxt_title.sym} -370 100 0 0 {name=l1 author="Joanne Low" note="Circuits created by Openram"}
