...
C {opin.sym} 450 -450 0 1 {name=p1484 lab=bl[0]}
C {opin.sym} 1000 -450 0 0 {name=p1485 lab=br[0]}
...
C {opin.sym} 450 -250 0 1 {name=p1 lab=bl[1:4]}
C {opin.sym} 1000 -250 0 0 {name=p2 lab=br[1:4]}
