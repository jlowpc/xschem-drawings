...
C {bus_connect.sym} 1080 -710 1 0 {name=l3 lab=addr[0]}
C {bus_connect.sym} 1080 -650 1 0 {name=l4 lab=addr[1]}
...
C {yxt_title.sym} 1240 290 0 0 {name=l28 author="Joanne Low" note="Circuits created by Openram"}
