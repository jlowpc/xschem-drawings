...
C {devices/nmos-sub.sym} -200 0 0 0 {name=Mmux_tx1 model=n substrate=gnd w=6.4u l=0.4u m=1}
C {devices/nmos-sub.sym} 290 0 0 0 {name=Mmux_tx2 model=n substrate=gnd w=6.4u l=0.4u m=1}
