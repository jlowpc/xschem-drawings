...
N 720 -130 750 -130 { lab=sel[0]}
N 90 -80 460 -80 { lab=wl_en}
C {devices/ipin.sym} 90 -160 0 0 {name=p1 lab=addr[0:3]}
...
C {devices/ipin.sym} 90 -100 0 0 {name=p8 lab=clk}
C {devices/ipin.sym} 90 -80 0 0 {name=p9 lab=wl_en}
C {devices/opin.sym} 750 -150 0 0 {name=p10 lab=wl[0:15]}
C {devices/opin.sym} 750 -130 0 0 {name=p11 lab=rbl_wl}
