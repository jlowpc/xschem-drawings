...
C {devices/nmos-sub.sym} 290 -60 0 0 {name=M1003 model=n substrate=gnd w=1.6u l=0.4u m=1}
C {devices/nmos-sub.sym} 170 -130 1 0 {name=M1004 model=n substrate=gnd w=0.8u l=0.4u m=1}
C {devices/pmos-sub.sym} 290 -160 0 0 {name=M1001 model=p substrate=vdd w=0.6u l=0.8u m=1}
C {devices/nmos-sub.sym} 430 -130 1 0 {name=M1005 model=n substrate=gnd w=0.8u l=0.4u m=1}
C {devices/nmos-sub.sym} 330 140 0 1 {name=M1002 model=n substrate=gnd w=1.6u l=0.4u m=1}
C {devices/pmos-sub.sym} 330 40 0 1 {name=M1000 model=p substrate=vdd w=0.6u l=0.8u m=1}
