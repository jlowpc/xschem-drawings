...
C {nmos-sub.sym} 0 40 0 0 {name=Mpnand2_nmos1
model=n substrate=gnd
l=0.4u
w=1.6u
m=1
}
C {pmos-sub.sym} -70 -50 0 0 {name=Mpnand2_pmos1
model=p substrate=vdd
l=0.4u
w=1.6u
m=1
}
C {pmos-sub.sym} 80 -50 0 0 {name=Mpnand2_pmos2
model=p substrate=vdd
l=0.4u
w=1.6u
m=1
}
C {nmos-sub.sym} 0 130 0 0 {name=Mpnand2_nmos2
model=n substrate=gnd
l=0.4u
w=1.6u
m=1
}
C {lab_pin.sym} 0 -110 0 0 {name=l1 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 20 170 0 0 {name=l2 sig_type=std_logic lab=gnd}
