...
C {port_address.sch} -870 -720 0 0 {name="" spice_ignore=true dash=5}
C {column.sch} 200 -1270 0 0 {name="" spice_ignore=true dash=5}
...
C {replica_column.sch} 140 390 0 0 {name="" spice_ignore=true dash=5}
...
C {row_decoder.sch} -400 450 0 0 {name="" spice_ignore=true dash=5}
C {col_decoder.sch} -710 910 0 0 {name="" spice_ignore=true dash=5}
C {control_logic_rw.sch} -970 10 0 0 {name="" spice_ignore=true dash=5}
C {row_addr_dff.sch} -1720 270 0 0 {name="" spice_ignore=true dash=5}
