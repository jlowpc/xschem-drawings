...
G {}
K {type=subcircuit
format="@name @@in_0 @@in_1 @@out_0 @@out_1 @@out_2 @@out_3 @vdd @gnd hierarchical_predecode2x4_0"
...
N 60 -250 90 -250 { lab=in_1}
N 170 -250 260 -250 { lab=inbar_1}
...
N 450 -330 470 -330 { lab=out_0}
N 450 -250 470 -250 { lab=out_1}
N 450 -170 470 -170 { lab=out_2}
N 450 -80 470 -80 { lab=out_3}
...
C {pinv_2.sym} 120 -330 0 0 {name=xpre_inv_0 vdd=vdd gnd=gnd}
C {pinv_2.sym} 120 -250 0 0 {name=xpre_inv_1 vdd=vdd gnd=gnd}
C {pand2.sym} 410 -330 0 0 {name=xXpre2x4_and_0 vdd=vdd gnd=gnd}
C {pand2.sym} 410 -250 0 0 {name=xXpre2x4_and_1 vdd=vdd gnd=gnd}
C {pand2.sym} 410 -170 0 0 {name=xXpre2x4_and_2 vdd=vdd gnd=gnd}
C {pand2.sym} 410 -80 0 0 {name=xXpre2x4_and_3 vdd=vdd gnd=gnd}
