...
C {nmos-sub.sym} -10 -20 0 0 {name=Mpnand3_nmos1
model=n substrate=gnd
l=0.4u
w=1.6u
m=1
}
C {pmos-sub.sym} -80 -110 0 0 {name=Mpnand3_pmos1
model=p substrate=vdd
l=0.4u
w=1.6u
m=1
}
C {pmos-sub.sym} 70 -110 0 0 {name=Mpnand3_pmos3
model=p substrate=vdd
l=0.4u
w=1.6u
m=1
}
C {nmos-sub.sym} -10 70 0 0 {name=Mpnand3_nmos2
model=n substrate=gnd
l=0.4u
w=1.6u
m=1
}
C {pmos-sub.sym} 190 -110 0 0 {name=Mpnand3_pmos2
model=p substrate=vdd
l=0.4u
w=1.6u
m=1
}
C {nmos-sub.sym} -10 160 0 0 {name=Mpnand3_nmos3
model=n substrate=gnd
l=0.4u
w=1.6u
m=1
}
C {lab_pin.sym} -10 -170 0 0 {name=l1 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 10 210 0 0 {name=l2 sig_type=std_logic lab=gnd}
