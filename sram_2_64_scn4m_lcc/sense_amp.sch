...
N 650 200 700 200 { lab=#net1}
N 700 200 700 290 { lab=#net1}
N 650 290 700 290 { lab=#net1}
N 820 230 820 260 { lab=#net1}
N 750 200 780 200 { lab=a_48_304#}
N 750 200 750 290 { lab=a_48_304#}
N 750 290 780 290 { lab=a_48_304#}
N 700 250 820 250 { lab=#net1}
...
C {devices/iopin.sym} 910 450 1 0 {name=p1494 lab=dout }
C {devices/iopin.sym} 430 100 0 1 {name=p1495 lab=en }
C {devices/pmos-sub.sym} 630 200 0 1 {name=M1004
model=p substrate=vdd
l=0.15u
w=1u
m=1
}
C {devices/pmos-sub.sym} 800 200 0 0 {name=M1003
model=p substrate=vdd
l=0.4u
w=3.6u
m=1
...
C {devices/nmos-sub.sym} 630 290 0 1 {name=M1002
model=n substrate=gnd
l=0.4u
w=1.8u
m=1
}
C {devices/nmos-sub.sym} 800 290 0 0 {name=M1001
model=n substrate=gnd
l=0.4u
w=1.8u
m=1
}
C {devices/nmos-sub.sym} 700 380 0 0 {name=M1000
model=n substrate=gnd
l=0.4u
w=1.8u
m=1
...
C {devices/pmos-sub.sym} 510 100 0 0 {name=M1006
model=p substrate=vdd
l=0.4u
w=4.8u
m=1
}
C {devices/pmos-sub.sym} 890 100 0 0 {name=M1005
model=p substrate=vdd
l=0.4u
w=4.8u
m=1
